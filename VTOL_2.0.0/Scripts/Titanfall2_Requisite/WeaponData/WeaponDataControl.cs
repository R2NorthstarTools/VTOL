...
using VTOL.Titanfall2_Requisite.WeaponData.Default.Grenadier;
...
namespace VTOL.Titanfall2_Requisite.WeaponData
{
    public class WeaponDataControl
    {
        ...
        public WeaponDataControl(string WeaponName, int imagecheck)
        {
            ...
            {
                Devotion devotion_clip = new Devotion();
            ...
            string[] name = MainWindow.GetTextureName(WeaponName);
            string str = name[0];
            string s = name[1];
            if (str.Contains("Default"))
            {
                switch (s)
                {
                    ...
                    case "AcogSight":
                        AcogSight acogsight = new AcogSight();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                        ...
                        break;
                    case "AogSight":
                        AogSight aogsight = new AogSight();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                    ...
                    case "HoloReflexSight":
                        HoloReflexSight holoreflexsight = new HoloReflexSight();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                    ...
                    //ProScreen只有512分辨率纹理
                    case "ProScreen":
                        ProScreen proscreen = new ProScreen();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                        ...
                        break;
                    case "SniperScope":
                        SniperScope sniperscope = new SniperScope();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                        ...
                        break;
                    case "SniperScopeX4":
                        SniperScopeX4 sniperscopex4 = new SniperScopeX4();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                    ...
                    case "Supressor":
                        ...
                        */
                        break;
                    case "ThreatScope":
                        ThreatScope threatscope = new ThreatScope();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                    ...
                    case "ThreatScopeSniper":
                        ThreatScopeSniper threatscopesniper = new ThreatScopeSniper();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                    ...
                    case "G2A5":
                        ...
                        break;
                    case "HemlokBFR":
                        HemlokBFR hemlokbfr = new HemlokBFR();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                    ...
                    case "R201":
                        ...
                        break;
                    case "V47Flatline":
                        V47Flatline v47flatline = new V47Flatline();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                    ...
                    case "Archer":
                        ...
                        break;
                    case "ChargeRifle":
                        ChargeRifle chargerifle = new ChargeRifle();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                    ...
                    //no ilm,ao,cav
                    case "PrimeSword":
                        PrimeSword primesword = new PrimeSword();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                    ...
                    case "Monarch":
                        ...
                        */
                        break;
                    case "PrimeLegion":
                        PrimeLegion primelegion = new PrimeLegion();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                        ...
                        break;
                    case "PrimeNorthstar":
                        PrimeNorthstar primenorthstar = new PrimeNorthstar();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                        ...
                        break;
                    case "PrimeION":
                        PrimeION primeion = new PrimeION();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                        ...
                        break;
                    case "PrimeRonin":
                        PrimeRonin primeronin = new PrimeRonin();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                        ...
                        break;
                    case "PrimeScorch":
                        PrimeScorch primescorch = new PrimeScorch();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                        ...
                        break;
                    case "PrimeTone":
                        PrimeTone primetone = new PrimeTone();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                        ...
                        break;
                    case "JackHandL":
                        JackHandL jackhandl = new JackHandL();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                        ...
                        break;
                    case "JackHandR":
                        JackHandR jackhandr = new JackHandR();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                        ...
                        break;
                    case "LeadWall":
                        LeadWall leadwall = new LeadWall();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                        ...
                        break;
                    case "PlasmaRailgun":
                        PlasmaRailgun plasmarailgun = new PlasmaRailgun();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                        ...
                        break;
                    case "PredatorCannon":
                        PredatorCannon predatorcannon = new PredatorCannon();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                        ...
                        break;
                    case "SplitterRifle":
                        SplitterRifle splitterrifle = new SplitterRifle();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                    ...
                    case "ThermiteLauncher":
                        ThermiteLauncher thermitelauncher = new ThermiteLauncher();
                        if (str.Contains("col"))
                        {
                            int i = 0;
                        ...
                        break;
                    case "TrackerCannon":
                        TrackerCannon trackercannon = new TrackerCannon();
                        if (str.Contains("col"))
                        {
                            int i = 0;
