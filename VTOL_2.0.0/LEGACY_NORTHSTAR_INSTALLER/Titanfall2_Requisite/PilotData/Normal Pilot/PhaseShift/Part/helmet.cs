...
namespace Titanfall2_SkinTool.Titanfall2.PilotData.Normal_Pilot.PhaseShift.Part
{
    class helmet
    {
        ...
        public helmet(String PartName, int imagecheck)
        {
