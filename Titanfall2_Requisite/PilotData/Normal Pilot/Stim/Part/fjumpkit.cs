...
namespace Titanfall2_SkinTool.Titanfall2.PilotData.Normal_Pilot.Stim.Part
{
    class fjumpkit
    {
        ...
        public fjumpkit(String PartName, int imagecheck)
        {
